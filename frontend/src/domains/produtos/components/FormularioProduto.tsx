...
export function FormularioProduto() {
  ...
  const [codProduto, setCodProduto] = useState(() => gerarCodigoProduto());
  ...
  return (
    <form className="cartao" onSubmit={aoEnviar}>
      ...
      <label>
        Código
        <input value={codProduto} onChange={(e) => setCodProduto(e.target.value)} required />
      </label>
      <label>
        Descrição simples
        <input value={descricaoSimples} onChange={(e) => setDescricaoSimples(e.target.value)} required />
      </label>
      <label>
        Descrição detalhada
        <input value={descricaoDetalhada} onChange={(e) => setDescricaoDetalhada(e.target.value)} />
      </label>
      <label>
        Unidade (enum numérico)
        <input type="number" value={unidade} onChange={(e) => setUnidade(Number(e.target.value))} min={1} required />
      </label>
      <label>
        Categoria (enum numérico)
        <input type="number" value={categoria} onChange={(e) => setCategoria(Number(e.target.value))} min={1} required />
      </label>
      <label>
        Lote inicial
