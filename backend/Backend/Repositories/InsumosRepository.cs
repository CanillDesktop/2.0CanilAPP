...
namespace Backend.Repositories
{
    ...
    {
        public InsumosRepository(CanilAppDbContext context, IUnidadeEstoqueContextService unidadeContext)
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var filtrada = FiltroHelper.AplicarFiltrosInsumos(
                FiltroHelper.Base(_context.Insumos.AsQueryable(), idUnidade),
                filtro,
                idUnidade);
